...
Uvozili smo podatke o mladih v obliki CSV z Eurostata ter v obliki HTML
z Eurostata. Poglejmo si začetka obeh uvoženih razpredelnic.
...
ggplot(drzave, aes(x = drzava)) + geom_histogram() +
